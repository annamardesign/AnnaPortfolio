  ...
  useEffect(() => {
    ...
    <div className="page">
     ...
     <div className="sticky">{project.title}</div>
      <div className="project-name"><img src={project.image} className="project-img" alt={project.title}
       style={{
       ...
       <button className="back-btn" onClick={() => history.push('/projects')}><TiArrowBackOutline style={{color:"#fff", fontSize:"2vw", fontWeight:"normal"}}/></button>
    </article>
